...
int main() {
  ...
  switch (opcao) {
    case 1:
      ...
      numeroSecreto = rand() % 10 + 1; // A função rand() gera um número aleatório inteiro, e o operador % 10 limita esse número ao intervalo de 0 a 9. Adicionando 1, obtemos um número entre 1 e 10.
